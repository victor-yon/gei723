...
def mouvement_pattes(N, eqs, methode):
...
def Monitors(G, up, avant, arriere):
    ...
    return M_G, M_up, spike_up, M_avant, spike_avant, M_arriere, spike_arriere

#Dec = StateMonitor(Declencheur, 'v', record = True)

M_G, M_up, spike_up, M_avant, spike_avant, M_arriere, spike_arriere = Monitor(G, up avant, arriere)

run(duration)

# Graphiques
def Graphs(M_G, M_up, spike_up, M_avant, spike_avant, M_arriere, spike_arriere ):
